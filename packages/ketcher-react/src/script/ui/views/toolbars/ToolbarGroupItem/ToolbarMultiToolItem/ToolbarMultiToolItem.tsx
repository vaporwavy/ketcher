...
const ToolbarMultiToolItem = (props: Props) => {
  ...
  return (
    <div ref={ref} className="toolbar-group-item">
      <ActionButton
        {...actionButtonProps}
        name={currentId}
        ...
        selected={selected}
      />
      <Icon className="dropdown-icon" name="dropdown" onClick={onOpenOptions} />

      {!isOpen ? null : (
        <Portal isOpen={isOpen} className="tool-options" style={portalStyle}>
